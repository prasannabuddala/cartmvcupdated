	...
	let allProducts = [];
	 function displayProducts(products) {
	        ...
	        $.each(products, function(ind, product){
	            ...
	            btn.attr("id",product.pid);
	            btn.attr("class","add-to-cart-btns");
	 ...
	 $(document).on('click', '.add-to-cart-btns', function() {
		 var btnid = $(this).attr("id");	   
		        $.ajax({
		            url : "CheckProductQuantityController",
		            method: "GET",
		            data: {
		                pidd: btnid
		            },
		            	...
		            	if(response == "success"){
		            		$.ajax({
		            			...
		            			error : function(xhr,status,err){
		            				console.log("error calling add to cart servlet");
		            			}
		            		});
		            	}
		            	else{
		            ...
		            error : function(xhr,status,err){
		            	console.log("error at checking quantity calling: "+err);
		            }
		        });
	    });
	$.ajax({
